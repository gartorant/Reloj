...
(
    ...
    localparam PAD1 = log2ceil(64'h4008800 - 64'h4008000); 
    localparam PAD2 = log2ceil(64'h8040000 - 64'h8000000); 
    localparam PAD3 = log2ceil(64'h10000008 - 64'h10000000); 
    localparam PAD4 = log2ceil(64'h10000018 - 64'h10000010); 
    localparam PAD5 = log2ceil(64'h10000040 - 64'h10000020); 
    localparam PAD6 = log2ceil(64'h10000080 - 64'h10000040); 
    localparam PAD7 = log2ceil(64'h10000090 - 64'h10000080); 
    localparam PAD8 = log2ceil(64'h100000a0 - 64'h10000090); 
    ...
    localparam PAD12 = log2ceil(64'h100000d8 - 64'h100000d0); 
    localparam PAD13 = log2ceil(64'h100000e8 - 64'h100000e0); 
    localparam PAD14 = log2ceil(64'h10000100 - 64'h100000f0); 
    ...
    localparam PAD18 = log2ceil(64'h10004000 - 64'h10002000); 
    // -------------------------------------------------------
    ...
    // ( 0x4008000 .. 0x4008800 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 29'h4008000   ) begin
    ...
    // ( 0x10000010 .. 0x10000018 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 29'h10000010  && read_transaction  ) begin
    ...
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 29'h10000080   ) begin
            src_channel = 19'b0000001000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 10;
    end

    // ( 0x10000090 .. 0x100000a0 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 29'h10000090   ) begin
    ...
    // ( 0x100000d0 .. 0x100000d8 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 29'h100000d0   ) begin
            src_channel = 19'b0000010000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 8;
    end

    // ( 0x100000e0 .. 0x100000e8 )
    if ( {address[RG:PAD13],{PAD13{1'b0}}} == 29'h100000e0   ) begin
            src_channel = 19'b0000100000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x100000f0 .. 0x10000100 )
    if ( {address[RG:PAD14],{PAD14{1'b0}}} == 29'h100000f0   ) begin
    ...
    if ( {address[RG:PAD18],{PAD18{1'b0}}} == 29'h10002000   ) begin
